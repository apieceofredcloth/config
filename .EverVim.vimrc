...
" EverVim options {
    ...
    let g:evervim_bundle_groups=['general', 'appearance', 'writing', 'programming', 'python', 'javascript', 'typescript', 'html', 'css', 'misc', 'go', 'rust', 'cpp', 'lua', 'neocomplete']

    " Color Theme
    " Use :Colors for a list of available colorschemes
    let g:evervim_color_theme="ir_black"
    let g:evervim_airline_theme="simple"
...
let b:ale_linters = {'python': ['pycodestyle']}
let b:ale_fixers = {'python': ['yapf']}

autocmd BufRead,BufNewFile *.conf setfiletype text
autocmd BufRead * set mouse=i
